...
#------------------------------------------------------------------------------------------------#
# PARTE 1: CONFIGURAÇÕES INICIAIS STREAMLIT
#------------------------------------------------------------------------------------------------#
...
# Habilita a pasta cache de dados
...
# Mapa caso queira visualizar os testes pré temporada
session_mapping = {
    'Practice 1': 1,
    'Practice 2': 2,
    'Practice 3': 3
...
# Cria um seletor para escolher entre as sessões do evento escolhido
...
#------------------------------------------------------------------------------------------------#
# AULA 2: CRIANDO UM TEMPLATE PARA ANÁLISE DE DADOS
#------------------------------------------------------------------------------------------------#
#------------------------------------------------------------------------------------------------#
...
# Os pilotos escolhidos serão armazenados em um dicionário
#------------------------------------------------------------------------------------------------#
...
with tabs[1]:
    ...
    # Aplica a função de estilo para todas as linhas de cada tabela
    ...
    try:
        ...
        with st.container():
            ...
            with col2:
                ...
                # Cria uma coleção de linhas (LineCollection) com base nos segmentos, usando o mapa de cores e a normalização. 
...
with tabs[4]:
    ...
    with st.container():
        ...
        with col1:
            ...
            #
            # -> lambda x: ...: Isso é uma expressão lambda em Python, uma forma para definir uma função anônima. Nesse caso, x representa cada valor individual na coluna 'LapTime'.
...
with tabs[5]:
    ...
    for driver in data.results['Abbreviation']:
        ...
        for _, stint in stints.iterrows():
            ...
            # Verifica se o composto de pneu existe no dicionário e 
